...
export class RolewisemenuComponent implements OnInit {
    ...
    isCreatedmenuData(paramsObj) {
        ...
        if (totalSelected > 0) {
            (<FormArray>this.rolewisemenuForm.get('menuList'))
                .controls[menuIndex].get('isCreated').setValue(true);
        } else {
            (<FormArray>this.rolewisemenuForm.get('menuList'))
                .controls[menuIndex].get('isCreated').setValue(false);
    ...
    showHideMenuList(params) {
        ...
        if (params !== undefined && params.index !== undefined) {
            if ((<FormArray>this.rolewisemenuForm.get('menuList')).controls[params.index].value.isShowChildrenList == false) {
                (<FormArray>this.rolewisemenuForm.get('menuList')).controls[params.index].get('isShowChildrenList').setValue(true);
            } else {
                (<FormArray>this.rolewisemenuForm.get('menuList')).controls[params.index].get('isShowChildrenList').setValue(false);
            }
