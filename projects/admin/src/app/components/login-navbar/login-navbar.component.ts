...
export class LoginnavbarComponent implements OnInit {
    ...
    constructor(location: Location, private element: ElementRef, private router: Router, public commonService: CommonService, public storageService: StorageService) {
        this.location = location;
        this.sidebarVisible = false;
        setTimeout(() => {
            if (this.storageService.getValue('logo') != "" || !!this.storageService.getValue('logo')) {
